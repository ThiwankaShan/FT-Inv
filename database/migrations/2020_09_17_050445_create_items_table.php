...
class CreateItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('items', function (Blueprint $table) {
            ...
            $table->foreign('subLocation_code')->references('subLocation_code')->on('sub_locations')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->foreign('subCategory_code')->references('subCategory_code')->on('sub_categories')->onUpdate('cascade')->onDelete('cascade');
            $table->string('type');
            $table->string('serial_number')->nullable()->unique();
            $table->string('model_number')->nullable();
            $table->string('brandName')->nullable();
            $table->integer('GRN_number');
            $table->foreign('GRN_number')->references('GRN_number')->on('grns')->onUpdate('cascade')->onDelete('cascade');
