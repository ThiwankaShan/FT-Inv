        ...
        <form action="{{ route('item.store') }}" method="POST">
            ...
            <div class="form-row col-sm-9 pl-0">
                <div class="form-group col-sm-6">
                    ...
                    <input type="number" class="form-control" id="noItems" value='1' placeholder="" name="Quantity" readonly>
                    @error('Quantity')
                    <span class="" role="alert">
                        <small style="color:red"><strong>{{ $message }}</strong></small>
                    </span>
                ...
                <div class="form-group col-sm-6 ">
                    ...
                    <input type="number" class="form-control" value="0" id="NoSub" placeholder="" name="sub_item" readonly>
                </div>
            </div>
