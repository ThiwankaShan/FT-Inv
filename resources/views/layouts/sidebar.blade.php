<div class="sidebar"  >
    ...
    <a href="{{route('item.create')}}"><i class="fa fa-lg fa-sitemap"></i><span class="collapse" id="side_bar">Create Items</span></a>
    ...
    <span class="collapse" id="side_bar">Inventory</span>
    </a>
